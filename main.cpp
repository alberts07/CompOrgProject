...
std::string names[(sizeof(holder)/sizeof(*holder))] = {"add $t0, $zero, $zero", "addi $t1, $t1, 0x0FFF", "sll $t2, $t1, 2", "sub sub $t3, $t2, $t1", "ori $t1, $t1, 0xF000", "addi $t0, $t0, 2", "slt $t5, $t0, $t3", "andi $t1, $t1, 0x10", "srl $t1, $t1, 3"};
